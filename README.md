...
> **엔카 매물, 살 만한 차인지 한눈에.**
_> 12가지 규칙으로 사고·이력·가격을 자동 채점하는 Chrome 사이드패널 확장.
...
<img src="screenshot/main-0.png" alt="AutoVerdict — 홈 페이지" width="40%" />
<img src="screenshot/main-1.png" alt="AutoVerdict — 스코어보드 + 레이더" width="40%" />
<img src="screenshot/main-2.png" alt="AutoVerdict — 룰 카드 목록" width="40%" />
<img src="screenshot/main-3.png" alt="AutoVerdict — AI 평가 탭" width="40%" />
<img src="screenshot/main-4.png" alt="AutoVerdict — MY LIST 탭" width="40%" />
...
[Core Bridge]     Layer B — 사이트 불문 ChecklistFacts 로 정규화
      │
      ▼
[Rules Engine]    12개 Pure 함수 → RuleReport {verdict, score, results}
      │
      ▼
